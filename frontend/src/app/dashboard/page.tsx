    ...
    useEffect(() => {
        const connect = () => {
            ...
            websocket.onerror = (event) => {
                // The error is typically an Event; include readyState for context
                const state = websocket.readyState;
                console.error("WebSocket error event:", { type: event?.type, readyState: state });
                setIsConnected(false);
                try {
                    // Proactively close to trigger onclose/reconnect flow
                    websocket.close();
                } catch (e) {
                    // noop
                }
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 py-3 sm:py-4">
                    <div className="flex items-center justify-between">
                        ...
                        <div className="flex items-center space-x-2 sm:space-x-4">
                            ...
                            <button
                                onClick={handleTradingDashboard}
                                className="flex items-center space-x-2 px-3 sm:px-4 py-2 bg-gradient-to-r from-blue-600 to-blue-700 hover:from-blue-700 hover:to-blue-800 rounded-xl transition-all duration-200 text-white border border-blue-500"
                            >
